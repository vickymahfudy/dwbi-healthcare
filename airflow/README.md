...
Pastikan terlebih dahulu sudah masuk ke dalam mode venv, dapat dilihat petunjuknya pada ([README.md](https://github.com/vickymahfudy/dwbi-healthcare/blob/main/README.md) di folder proyek utama.
---
